        ...
        <div className="home-stats-card">
          <div className="stats-header">
            ...
            <div className="stat-item">
              ...
              <p className="stat-value in-stock">87</p>
            </div>
            <div className="stat-item">
              <p className="stat-label">
                Sold <br /> Out
              </p>
              <p className="stat-value sold-out">13</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card-section">
        ...
        <div className="store-member-stats-card">
          <div className="store-member-stat-item">
            ...
            <p className="store-member-stat-value">2</p>
          </div>
          <div className="store-member-stat-item">
            <p className="store-member-stat-label">Sales Persons</p>
            <p className="store-member-stat-value">5</p>
          </div>
        </div>
      </div>
    </div>
